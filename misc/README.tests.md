...
## 2.7: ou18.ics, ouc18.ics

UTF-8をshift_jisに変換するときにエラーとなる文字を読み替える表のテスト。
引数-Eの説明参照。

4バイトUTF-8「𠮷」は頭が土(U+20BB7).吉野家は正しくはこの漢字。

「家族」の絵文字は以下参照。絵文字が一文字だが、5個のUTF-8で構成される。
また環境によっては正しく表示されない。

Ref: https://lets-emoji.com/emojilist/emojilist-28/#google_vignette

※末尾に改行分の差分が出てたため、ICSを手作業で修正している。

```:text
-TEST:160:UTF-8各種絵文字📣
2026年6月7日 10:00-10:30
UTF-8の半角スペース:" "
4バイトUTF-8:𠮷
笑い:😀
花:🌸
...
-TEST:161:UTF-8各種文字
2026年6月7日 10:30-11:00
年号:㍾,㍽,㍼,㍻,㋿.
(株):㈱
ギリシャ数字:Ⅰ,Ⅱ,Ⅲ,Ⅳ,Ⅴ,Ⅵ,Ⅶ,Ⅷ,Ⅸ,Ⅹ,Ⅺ,Ⅻ.
丸数字:①-⑳.
カッコ数字:⑴-⒇.
以上
```
